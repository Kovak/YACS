...
class SoundController(EventDispatcher):
    sound_dir = StringProperty('assets/soundfx/')

    def __init__(self, **kwargs):
        super(SoundController, self).__init__(**kwargs)
        self.sound_dict = {}
    ...
    def play(self, sound_name):
        sound = self.sound_dict.get(sound_name, None)
...
class MusicController(EventDispatcher):
